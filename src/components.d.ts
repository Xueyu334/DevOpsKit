...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconEpShieldCheck: typeof import('~icons/ep/shield-check')['default']
...
declare global {
  ...
  const IconEpArrowDown: typeof import('~icons/ep/arrow-down')['default']
  ...
  const IconEpShieldCheck: typeof import('~icons/ep/shield-check')['default']
